            ...
            <div className="flex items-center gap-4 sm:gap-2">
              {tabs.map((tab) => (
                <button
                  ...
                  className={`relative flex items-center gap-2 py-2 px-4 font-bold whitespace-nowrap rounded-full transition-all duration-300 text-sm sm:text-base ${
                    activeTab === tab.label
                ...
                >
                  {tab.label === "General" && (
                    <img src={StarIcon} alt="star" className="w-4 h-4 sm:w-5 sm:h-5 object-contain" />
                  )}
