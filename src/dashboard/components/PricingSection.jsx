...
export default function PricingSection({
  ...
  return (
    <div className="w-full overflow-x-s hide-scrollbar  py-8 sm:py-12 lg:py-16 text-white bg-black flex flex-col items-center justify-center mx-auto">
      ...
      <div className="relative">
        {/* Scrollable Cards */}
        <div className="flex flex-nowrap gap-4 sm:gap-4 lg:gap-4 pb-4 sm:pb-6 overflow-x-auto hide-scrollbar px-1">
