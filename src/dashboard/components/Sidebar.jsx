  ...
  return (
    <div className="relative">
      <div className="relative my-2 mx-3 rounded-3xl">
        ...
        <aside
          className={`fixed sm:sticky top-0 left-0 h-screen border-2 border-[#1a1a1a] bg-[#1D1B25] shadow-lg
          ...
          <div className="flex flex-col h-full justify-start gap-48">
            <div>
              ...
              <div
                className={
                  isCollapsed
                    ? "w-full fixed z-50 top-12 left-10 hidden sm:flex justify-end transition-all duration-300"
                    : "w-1/4 fixed z-50 top-24 left-56 hidden sm:flex justify-end transition-all duration-300"
                }
              >
                <button
            ...
            <div className="p-4">
              <Link
                ...
                className={
                  isCollapsed
                    ? `flex items-center gap-3 rounded-lg transition-all duration-200 text-gray-400`
